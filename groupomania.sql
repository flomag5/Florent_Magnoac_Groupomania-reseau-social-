...
CREATE TABLE `comments` (
  ...
  KEY `fk_userId_2_idx` (`userId`),
  CONSTRAINT `fk_postId` FOREIGN KEY (`postId`) REFERENCES `posts` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_userId_1` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `users` VALUES (110,'Groupomania','Administrateur','48156794c92699c74c3af0aa95f47c5ba2606414ab04d84bd18c4d307abc274a','$2b$10$Ba8FciCfPNPyUm.hGveal.LjUuWFeLW18za2MhCFxMImM2XvcX2ue','http://localhost:3000/images_default/default_user_profile.png',1,'2022-02-20 09:27:27','2022-02-20 09:27:27');
...
-- Dump completed on 2022-02-20 10:34:11
